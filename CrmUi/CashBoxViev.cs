...
namespace CrmUi
{
    class CashBoxViev
    {
        ...
        public CashBoxViev(CashDesk cashDask, int number, int x, int y)
        {
            this.cashDesk = cashDask;
            ...
            CashDeskName.Text = cashDask.ToString();
            ...
            QueueLenght.Maximum = cashDask.MaxQueueLenght;
