...
namespace CrmUi
{
    public partial class Main : Form
    {
        ...
        private void СheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(customer != null)
            {
                ...
                MessageBox.Show($"Покупка выплнена успешно. Сума:  {price} грн", "Покупка выполнена", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
